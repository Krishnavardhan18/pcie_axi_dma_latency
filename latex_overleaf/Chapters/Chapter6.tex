...
\texttt{axi\_mm2s\_adapter}, \texttt{axis\_fifo} & Zero-latency \texttt{tkeep} correction and FWFT FIFO implemented and unit-checked against hand-computed \texttt{tkeep} masks for packet sizes not aligned to the bus width. \\
